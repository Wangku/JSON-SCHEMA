 icon = ["./images/icon_resource.png","./images/icon_element.gif", "./images/icon_reference.png","./images/icon_datatype.gif","./images/icon_primitive.png"];
 if (function(a, b) { "use strict"; "object" == typeof exports ? module.exports = b(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" == typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], b) : a.URI = b(a.punycode, a.IPv6, a.SecondLevelDomains, a) }(this, function(a, b, c, d) {
        "use strict";
        ...
        e.encodeReserved = u("reserved", "encode"), e.parse = function(a, b) {
            ...
            return d.URI === this && (d.URI = p), this
        }, q.build = function(a) {
            ...
            return new e(this)
        }, q.valueOf = q.toString = function() {
            return this.build(!1)._string
        }, q.protocol = n("protocol"), q.username = n("username"), q.password = n("password"), q.hostname = n("hostname"), q.port = n("port"), q.query = o("query", "?"), q.fragment = o("fragment", "#"), q.search = function(a, b) {
            var c = this.query(a, b);
            return "string" == typeof c && c.length ? "?" + c : c
        }, q.hash = function(a, b) {
            var c = this.fragment(a, b);
            return "string" == typeof c && c.length ? "#" + c : c
        }, q.pathname = function(a, b) {
            if (void 0 === a || a === !0) {
        ...
        }, q.path = q.pathname, q.href = function(a, b) {
            var c;
        ...
        }, q.scheme = q.protocol, q.port = function(a, b) {
        ...
        return q.query = function(a, b) {
            ...
            return void 0 !== a && "string" != typeof a ? (this._parts.query = e.buildQuery(a, this._parts.duplicateQueryParameters, this._parts.escapeQuerySpace), this.build(!b), this) : y.call(this, a, b)
        }, q.setQuery = function(a, b, c) {
        ...
        }, q.hasQuery = function(a, b, c) {
            var d = e.parseQuery(this._parts.query, this._parts.escapeQuerySpace);
            return e.hasQuery(d, a, b, c)
        }, q.setSearch = q.setQuery, q.addSearch = q.addQuery, q.removeSearch = q.removeQuery, q.hasSearch = q.hasQuery, q.normalize = function() {
        ...
        }, q.normalizePathname = q.normalizePath, q.normalizeQuery = function(a) {
        ...
        }, q.normalizeFragment = function(a) {
            return this._parts.fragment || (this._parts.fragment = null, this.build(!a)), this
        }, q.normalizeSearch = q.normalizeQuery, q.normalizeHash = q.normalizeFragment, q.iso8859 = function() {
            var a = e.encode,
                b = e.decode;
            ...
            return !0
        }, q.duplicateQueryParameters = function(a) {
            return this._parts.duplicateQueryParameters = !!a, this
        }, q.escapeQuerySpace = function(a) {
            return this._parts.escapeQuerySpace = !!a, this
        }, e
    }), function(a, b) { "function" == typeof define && define.amd ? define([], b) : "undefined" != typeof module && module.exports ? module.exports = b() : a.tv4 = b() }(this, function() {
        function a(a) {
        ...
        function j(a, b, c, d, e) {
            ...
            if (this.stack = f.stack || f.stacktrace, !this.stack) try {
                throw f
            } catch (f) { this.stack = f.stack || f.stacktrace }
        }
                ...
                e = {
                    ...
                    validate: function(a, e, f, g) {
                        var h = i(b),
                            ...
                            k = new o(d, !1, j, f, g);
                        "string" == typeof e && (e = { $ref: e }), k.addSchema("", e);
        ...
        o.prototype.defineKeyword = function(a, b) { this.definedKeywords[a] = this.definedKeywords[a] || [], this.definedKeywords[a].push(b) }, o.prototype.createError = function(a, b, c, d, e, f, g) {
            ...
            if (-1 !== a.indexOf("#") && (e = a.substring(a.indexOf("#") + 1), d = a.substring(0, a.indexOf("#"))), "object" == typeof this.schemas[d]) {
                ...
                if (c.allOf.length == 1) {
                    (c.allOf)[0].id = s;
                    for (var name in (c.allOf)[0].properties) {
                        ((c.allOf)[0].properties)[name].id = s;
                    }}
                else {
                    (c.allOf)[1].id = s;
            ...
            var b = [];
            for (var cc in this.missingMap) {
                if (cc.indexOf("ResourceList") > -1) { delete this.missingMap[cc] } };
            ...
            return "string" == typeof c || "number" == typeof c ? this.createError(r.FORMAT_CUSTOM, { message: c }, "", "/format", null, a, b) : c && "object" == typeof c ? this.createError(r.FORMAT_CUSTOM, { message: c.message || "?" }, c.dataPath || "", c.schemaPath || "/format", null, a, b) : null
            ...
            return this.createError(r.INVALID_TYPE, { type: c, expected: d.join("/") }, "", "", null, a, b)
            ...
            return this.createError(r.ENUM_MISMATCH, { value: "undefined" != typeof JSON ? JSON.stringify(a) : a }, "", "", null, a, b)
        ...
        o.prototype.validateMultipleOf = function(a, b) {
            ...
            return "number" != typeof a ? null : isNaN(a) === !0 || a === 1 / 0 || a === -(1 / 0) ? this.createError(r.NUMBER_NOT_A_NUMBER, { value: a }, "", "/type", null, a, b) : null
            ...
            return "string" != typeof a ? null : void 0 !== b.minLength && a.length < b.minLength ? this.createError(r.STRING_LENGTH_SHORT, { length: a.length, minimum: b.minLength }, "", "/minLength", null, a, b) : void 0 !== b.maxLength && a.length > b.maxLength ? this.createError(r.STRING_LENGTH_LONG, { length: a.length, maximum: b.maxLength }, "", "/maxLength", null, a, b) : null
            ...
            return c.test(a) ? null : this.createError(r.STRING_PATTERN, { pattern: b.pattern }, "", "/pattern", null, a, b)
            ...
            if (Array.isArray(b.items)) {
                ...
                for (e = 0; e < a.length; e++)
                    if (d = this.validateAll(a[e], b.items, [e], ["items"], c + "/" + e)) return d; return null
            ...
            for (var e in a) {
                ...
                if (g) this.trackUnknownProperties && (this.knownPropertyPaths[f] = !0, delete this.unknownPropertyPaths[f]);
                    ...
                    if (this.trackUnknownProperties && (this.knownPropertyPaths[f] = !0, delete this.unknownPropertyPaths[f]), "boolean" == typeof b.additionalProperties) {
                        if (!b.additionalProperties && (d = this.createError(r.OBJECT_ADDITIONAL_PROPERTIES, { key: e }, "", "/additionalProperties", null, a, b).prefixWith(e, null), this.handleError(d))) return d
            ...
            if (void 0 !== b.dependencies)
                for (var e in b.dependencies)
                    if (void 0 !== a[e]) {
                        ...
                        if ("string" == typeof f) {
                            if (void 0 === a[f] && (d = this.createError(r.OBJECT_DEPENDENCY_KEY, { key: e, missing: f }, "", "", null, a, b).prefixWith(null, e).prefixWith(null, "dependencies"), this.handleError(d))) return d
                        } else if (Array.isArray(f))
                            for (var g = 0; g < f.length; g++) {
                                var h = f[g];
                                if (void 0 === a[h] && (d = this.createError(r.OBJECT_DEPENDENCY_KEY, { key: e, missing: h }, "", "/" + g, null, a, b).prefixWith(null, e).prefixWith(null, "dependencies"), this.handleError(d))) return d
        ...
        if (d.length || a) {
            ...
            $.when.apply($, f).done(function() { tv4.asyncLoad(!1, b, c) })
        } else {
            if (!b) return !0;
            b(tv4.getSchemaMap())
        }
    ...
    }("function" == typeof define && define.amd ? define : function(a, b) { "undefined" != typeof module && module.exports ? module.exports = b(require("jquery")) : b(jQuery) }), ! function() {
        function a(a) {
            ...
            if (d.createSVGPoint) {
                ...
                if (0 > Cg) {
                    ...
                    if (f.scrollX || f.scrollY) {
                        d = bg.select("body").append("svg").style({ position: "absolute", top: 0, left: 0, margin: 0, padding: 0, border: "none" }, "important");
        ...
        function Ca(a, b, c, d) {
            ...
            return !this.XDomainRequest || "withCredentials" in i || !/^(http(s)?:)?\/\//.test(a) || (i = new XDomainRequest), "onload" in i ? i.onload = i.onerror = e : i.onreadystatechange = function() { i.readyState > 3 && e() }, i.onprogress = function(a) {
                var b = bg.event;
                bg.event = a;
                try { g.progress.call(f, i) } finally { bg.event = b }
                ...
                return null != b && i.overrideMimeType && i.overrideMimeType(b), null != j && (i.responseType = j), null != e && f.on("error", e).on("load", function(a) { e(null, a) }), g.beforesend.call(f, i), i.send(null == d ? null : d), f
            }, f.abort = function() {
                return i.abort(), f
        ...
        function Ab() {
            ...
            }, Fh.lineEnd = function() { a(b, c), Fh.lineEnd = zb, Fh.point = wb }
        }
            ...
            return function(e, f) {
                ...
                var n, o, p, q = b(f),
                    ...
                    s = {
                        ...
                        lineStart: i,
                        lineEnd: j,
                        polygonStart: function() { s.point = k, s.lineStart = l, s.lineEnd = m, n = [], o = [] },
                        polygonEnd: function() {
                        ...
                        sphere: function() { f.polygonStart(), f.lineStart(), c(null, null, 1, f), f.lineEnd(), f.polygonEnd() }
                    },
                    t = Ib(),
                    u = b(t),
                    v = !1;
        ...
        function Ib() {
            var a, b = [];
            return {
                lineStart: function() { b.push(a = []) },
                point: function(b, c) { a.push([b, c]) },
                lineEnd: v,
                buffer: function() {
                    var c = b;
                    return b = [], a = null, c
                },
                rejoin: function() { b.length > 1 && b.push(b.pop().concat(b.shift())) }
            }
        }
        ...
        function Kb(a) {
            var b, c = NaN,
                ...
                e = NaN;
            return {
                lineStart: function() { a.lineStart(), b = 1 },
                point: function(f, g) {
                    var h = f > 0 ? Fg : -Fg,
                        i = ng(f - c);
                ...
                lineEnd: function() { a.lineEnd(), c = d = NaN },
                clean: function() {
                    return 2 - b
                }
            }
        ...
        function Ob(a) {
            ...
            function c(a) {
                ...
                return {
                    ...
                    lineEnd: function() { i && a.lineEnd(), c = null },
                    clean: function() {
                        return k | (j && i) << 1
                    }
                }
            ...
            return function(h) {
                ...
                var p, q, r, s, t, u, v, w, x, y, z, A = h,
                    ...
                    D = {
                        ...
                        lineStart: m,
                        lineEnd: n,
                        polygonStart: function() { h = B, p = [], q = [], z = !0 },
                        polygonEnd: function() {
                            h = A, p = bg.merge(p);
                            var b = i([a, d]),
                                c = z && b,
        ...
        function Vb() {
            ...
            var f = Wb(4.5),
                ...
                h = {
                    point: a,
                    lineStart: function() { h.point = b },
                    lineEnd: d,
                    polygonStart: function() { h.lineEnd = e },
                    polygonEnd: function() { h.lineEnd = d, h.point = a },
        ...
        function _b(a) {
            ...
            var g = 4.5,
                h = {
                    point: b,
                    lineStart: function() { h.point = c },
                    lineEnd: e,
                    polygonStart: function() { h.lineEnd = f },
                    polygonEnd: function() { h.lineEnd = e, h.point = b },
                    pointRadius: function(a) {
                        return g = a, h
                    },
                    result: v
        ...
        var bg = { version: "3.5.6" },
            ...
            eg = this.document;
        if (eg) try { dg(eg.documentElement.childNodes)[0].nodeType } catch (fg) {
            dg = function(a) {
        ...
        if (Date.now || (Date.now = function() {
                return +new Date
            }), eg) try { eg.createElement("DIV").style.setProperty("opacity", 0, "") } catch (gg) {
        ...
        bg.ns = {
            ...
            qualify: function(a) {
                var b = a.indexOf(":"),
                    c = a;
                return b >= 0 && (c = a.slice(0, b), a = a.slice(b + 1)), xg.hasOwnProperty(c) ? { space: xg[c], local: a } : a
            }
            ...
            } : null == a ? function() { this.textContent = "" } : function() { this.textContent = a }) : this.node().textContent
        }, wg.html = function(a) {
            return arguments.length ? this.each("function" == typeof a ? function() {
                var b = a.apply(this, arguments);
                this.innerHTML = null == b ? "" : b
            } : null == a ? function() { this.innerHTML = "" } : function() { this.innerHTML = a }) : this.node().innerHTML
            ...
            return R(this, function(b, c, d) { a.call(b, b.__data__, c, d) })
        }, wg.call = function(a) {
            var b = dg(arguments);
        ...
        bg.interpolateZoom = function(a, b) {
            ...
            return Pg || (Pg = "onwheel" in eg ? (Og = function() {
                ...
                a.each(function() {
                    ...
                    }).each("interrupt.zoom", function() { k(a) }).each("end.zoom", function() { k(a) }) : (this.__chart__ = z, i(a), j(a), k(a))
                })
            }, a.translate = function(b) {
                return arguments.length ? (z = { x: +b[0], y: +b[1], k: z.k }, h(), a) : [z.x, z.y]
            }, a.scale = function(b) {
                return arguments.length ? (z = { x: z.x, y: z.y, k: +b }, h(), a) : z.k
        ...
        }, bg.timer.flush = function() { Ga(), Ha() }, bg.round = function(a, b) {
        ...
        Ma.prototype = {
            ...
            setDate: function() { jh.setUTCDate.apply(this._, arguments) },
            setDay: function() { jh.setUTCDay.apply(this._, arguments) },
            setFullYear: function() { jh.setUTCFullYear.apply(this._, arguments) },
            setHours: function() { jh.setUTCHours.apply(this._, arguments) },
            setMilliseconds: function() { jh.setUTCMilliseconds.apply(this._, arguments) },
            setMinutes: function() { jh.setUTCMinutes.apply(this._, arguments) },
            setMonth: function() { jh.setUTCMonth.apply(this._, arguments) },
            setSeconds: function() { jh.setUTCSeconds.apply(this._, arguments) },
            setTime: function() { jh.setTime.apply(this._, arguments) }
        };
        var jh = Date.prototype;
        hh.year = Na(function(a) {
            return a = hh.day(a), a.setMonth(0, 1), a
        }, function(a, b) { a.setFullYear(a.getFullYear() + b) }, function(a) {
        ...
        }, function(a, b) { a.setDate(a.getDate() + b) }, function(a) {
            return a.getDate() - 1
            ...
            }, function(a, b) { a.setDate(a.getDate() + 7 * Math.floor(b)) }, function(a) {
        ...
        bg.format = nh.numberFormat, bg.geo = {}, ib.prototype = {
            s: 0,
            t: 0,
            add: function(a) { jb(a, this.t, oh), jb(oh.s, this.s, this), this.s ? this.t += oh.t : this.s = oh.t },
        ...
        var rh, sh = new ib,
            th = {
                sphere: function() { rh += 4 * Fg },
                point: v,
                lineStart: v,
                lineEnd: v,
                polygonStart: function() { sh.reset(), th.lineStart = nb },
                polygonEnd: function() {
                    var a = 2 * sh;
        ...
        bg.interpolate = rd, bg.interpolators = [function(a, b) {
            var c = typeof b;
            return ("string" === c ? Zg.has(b.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(b) ? nd : qd : b instanceof ga ? nd : Array.isArray(b) ? sd : "object" === c && isNaN(b) ? od : pd)(a, b)
        ...
        bg.interpolateTransform = Od, bg.layout = {}, bg.layout.bundle = function() {
            ...
            return h.tick = function() {
                ...
                return arguments.length ? (a = +a, d ? d = a > 0 ? a : 0 : a > 0 && (i.start({ type: "start", alpha: d = a }), bg.timer(h.tick)), h) : d
            }, h.start = function() {
                function a(a, d) {
                    if (!c) {
        ...
        bg.layout.hierarchy = function() {
            ...
            function a(g) {
                ...
                return null != c && p.sort(c === oi ? function(a, b) {
                    ...
                    return c(g[a], g[b])
                }), p.forEach(function(a) { q[a] = { data: g[a], value: h = j[a], startAngle: k, endAngle: k += h * o + n, padAngle: m } }), q
            }
            var b = Number,
                c = oi,
                d = 0,
        ...
        wg.transition = function(a) {
            for (var b, c, d = Hi || ++Li, e = Uf(a), f = [], g = Ii || { time: Date.now(), ease: yd, delay: 0, duration: 250 }, h = -1, i = this.length; ++h < i;) {
                f.push(b = []);
        ...
        Ki.call = wg.call, Ki.empty = wg.empty, Ki.node = wg.node, Ki.size = wg.size, bg.transition = function(a, b) {
            ...
            Ki.attr = function(a, b) {
                ...
                var b = this.id,
                    c = this.namespace;
                return arguments.length < 1 ? this.node()[c][b].ease : ("function" != typeof a && (a = bg.ease.apply(bg, arguments)), R(this, function(d) { d[c][b].ease = a }))
            }, Ki.delay = function(a) {
                var b = this.id,
                    c = this.namespace;
                return arguments.length < 1 ? this.node()[c][b].delay : R(this, "function" == typeof a ? function(d, e, f) { d[c][b].delay = +a.call(d, d.__data__, e, f) } : (a = +a, function(d) { d[c][b].delay = a }))
            }, Ki.duration = function(a) {
                var b = this.id,
                    c = this.namespace;
                return arguments.length < 1 ? this.node()[c][b].duration : R(this, "function" == typeof a ? function(d, e, f) { d[c][b].duration = Math.max(1, a.call(d, d.__data__, e, f)) } : (a = Math.max(1, a), function(d) { d[c][b].duration = a }))
                ...
                if (arguments.length < 2) {
                    var e = Ii,
                        f = Hi;
                    try { Hi = c, R(this, function(b, e, f) { Ii = b[d][c], a.call(b, b.__data__, e, f) }) } finally { Ii = e, Hi = f }
                ...
                a.each(function() {
                    ...
                    this.__chart__ = b, Hi ? bg.select(this).transition().each("start.brush", function() { g = c.i, h = c.j, l = c.x, m = c.y, a({ type: "brushstart" }) }).tween("brush:brush", function() {
                        var c = sd(l, b.x),
                            d = sd(m, b.y);
                        return g = h = null,
                            function(e) { l = b.x = c(e), m = b.y = d(e), a({ type: "brush", mode: "resize" }) }
                    }).each("end.brush", function() { g = b.i, h = b.j, a({ type: "brush", mode: "resize" }), a({ type: "brushend" }) }) : (a({ type: "brushstart" }), a({ type: "brush", mode: "resize" }), a({ type: "brushend" }))
                })
            }, a.x = function(b) {
        ...
        }, function(a, b) { a.setTime(a.getTime() + 1e3 * Math.floor(b)) }, function(a) {
            return a.getSeconds()
        }), hh.seconds = hh.second.range, hh.seconds.utc = hh.second.utc.range, hh.minute = Na(function(a) {
            return new ih(6e4 * Math.floor(a / 6e4))
        }, function(a, b) { a.setTime(a.getTime() + 6e4 * Math.floor(b)) }, function(a) {
            return a.getMinutes()
        ...
        }, function(a, b) { a.setTime(a.getTime() + 36e5 * Math.floor(b)) }, function(a) {
            return a.getHours()
        }), hh.hours = hh.hour.range, hh.hours.utc = hh.hour.utc.range, hh.month = Na(function(a) {
            return a = hh.day(a), a.setDate(1), a
        }, function(a, b) { a.setMonth(a.getMonth() + b) }, function(a) {
            return a.getMonth()
        ...
        function i(a, b, d) {
            ...
            l && (k = c(s), k.onmessage = function(a) {
                var b = a.data.file,
                    c = a.data.result;
                b.extra || (b.extra = a.data.extra), b.extra.ended = new Date, d.on["error" === c ? "error" : "load"]({ target: { result: c } }, b), f()
                ...
                if (k) k.postMessage({ file: b, extra: b.extra, readAs: c });
                    ...
                    var e = new q;
                    e.originalEvent = a, u.forEach(function(a) {
                        e["on" + a] = function(c) {
                            ("load" == a || "error" == a) && (b.extra.ended = new Date), d.on[a](c, b), "loadend" == a && f()
                        }
                    }), e[c](b)
                }
            })
        ...
        var q = a.FileReader,
            ...
            w = a.FileReaderJS = {
                ...
                setupDrop: f,
                setupClipboard: d,
                setSync: function(a) { v = a, v && !r && j() },
                getSync: function() {
                    return v && r
                },
                output: [],
                opts: { dragClass: "drag", accept: !1, readAsDefault: "DataURL", readAsMap: {}, on: { loadstart: k, progress: k, load: k, abort: k, error: k, loadend: k, skip: k, groupstart: k, groupend: k, beforestart: k } }
            };
        if ("undefined" != typeof jQuery && (jQuery.fn.fileReaderJS = function(a) {
                return this.each(function() { jQuery(this).is("input") ? e(this, a) : f(this, a) })
            }, jQuery.fn.fileClipboard = function(a) {
                return this.each(function() { d(this, a) })
            }), q) {
            var x = function(a) {
                    return function() {
                        return a++
            ...
            function d(e, f) {
                if (!e.compiled) {
                    if (e.compiled = !0, e.k = e.k || e.bK, e.k) {
                        ...
                        "string" == typeof e.k ? i("keyword", e.k) : Object.keys(e.k).forEach(function(a) { i(a, e.k[a]) }), e.k = h
                    }
        ...
        function k(a, c, e, f) {
            ...
            try {
                ...
                return { r: C, value: A, language: a, top: y }
            } catch (G) {
        ...
        return a.highlight = k, a.highlightAuto = l, a.fixMarkup = m, a.highlightBlock = o, a.configure = p, a.initHighlighting = q, a.initHighlightingOnLoad = r, a.registerLanguage = s, a.listLanguages = t, a.getLanguage = u, a.inherit = g, a.IR = "[a-zA-Z]\\w*", a.UIR = "[a-zA-Z_]\\w*", a.NR = "\\b\\d+(\\.\\d+)?", a.CNR = "(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", a.BNR = "\\b(0b[01]+)", a.RSR = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", a.BE = { b: "\\\\[\\s\\S]", r: 0 }, a.ASM = { cN: "string", b: "'", e: "'", i: "\\n", c: [a.BE] }, a.QSM = { cN: "string", b: '"', e: '"', i: "\\n", c: [a.BE] }, a.PWM = { b: /\b(a|an|the|are|I|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such)\b/ }, a.C = function(b, c, d) {
            ...
            return e.c.push(a.PWM), e.c.push({ cN: "doctag", b: "(?:TODO|FIXME|NOTE|BUG|XXX):", r: 0 }), e
        }, a.CLCM = a.C("//", "$"), a.CBCM = a.C("/\\*", "\\*/"), a.HCM = a.C("#", "$"), a.NM = { cN: "number", b: a.NR, r: 0 }, a.CNM = { cN: "number", b: a.CNR, r: 0 }, a.BNM = { cN: "number", b: a.BNR, r: 0 }, a.CSSNM = { cN: "number", b: a.NR + "(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?", r: 0 }, a.RM = { cN: "regexp", b: /\//, e: /\/[gimuy]*/, i: /\n/, c: [a.BE, { b: /\[/, e: /\]/, r: 0, c: [a.BE] }] }, a.TM = { cN: "title", b: a.IR, r: 0 }, a.UTM = { cN: "title", b: a.UIR, r: 0 }, a
        ...
        return { cI: !0, i: /[=\/|'\$]/, c: [a.CBCM, d, { cN: "id", b: /\#[A-Za-z0-9_-]+/ }, { cN: "class", b: /\.[A-Za-z0-9_-]+/ }, { cN: "attr_selector", b: /\[/, e: /\]/, i: "$" }, { cN: "pseudo", b: /:(:)?[a-zA-Z0-9\_\-\+\(\)"']+/ }, { cN: "at_rule", b: "@(font-face|page)", l: "[a-z-]+", k: "font-face page" }, { cN: "at_rule", b: "@", e: "[{;]", c: [{ cN: "keyword", b: /\S+/ }, { b: /\s/, eW: !0, eE: !0, r: 0, c: [c, a.ASM, a.QSM, a.CSSNM] }] }, { cN: "tag", b: b, r: 0 }, { cN: "rules", b: "{", e: "}", i: /\S/, c: [a.CBCM, d] }] }
    ...
    }), window.location.origin || (window.location.origin = window.location.protocol + "//" + window.location.hostname + (window.location.port ? ":" + window.location.port : "")), "undefined" == typeof JSV) var JSV = {
    schema: "",
    plain: !1,
    version: "",
    focusNode: !1,
    ...
    maxLabelLength: 0,
    maxDepth: 20,
    labels: { allOf: !0, anyOf: !0, oneOf: !0, "object{ }": !0 },
    baseSvg: null,
    svgGroup: null,
    init: function(a, b) {
        var c;
        ...
        var d = function() {
            ...
            JSV.visit(JSV.treeData, function(b) { b.isReal && a.push(b.plainName + "|" + JSV.getNodePath(b).join("-")) }, function(a) {
                return a.children || a._children
            }), a.sort(), JSV.buildSearchList(a, !0), $("#loading").fadeOut("slow")
        };
        JSV.createDiagram(d), JSV.initValidator(), $("#popup-error").enhanceWithin().popup(), $.fn.highlight = function(a, b, c) {
            var d = c ? '\\"\\b' + a + '\\b\\"' : "\\b" + a + "\\b",
                e = new RegExp(d, "g");
            return this.each(function() {
                this.innerHTML = this.innerHTML.replace(e, function(a) {
                    return '<span class="' + b + '">' + a + "</span>"
                })
            })
        }, $("body").on("pagecontainershow", function(a, b) {
            var c = b.toPage;
            "viewer-page" === c.attr("id") && JSV.viewerInit && (c.jqmData("infoOpen") && $("#info-panel").panel("open"), JSV.contentHeight(), 0 === $("svg#jsv-tree").height() && ($("svg#jsv-tree").attr("width", $("#main-body").width()).attr("height", $("#main-body").height()), JSV.resizeViewer(), JSV.resetViewer()))
        }), $("body").on("pagecontainerbeforehide", function(a, b) {
            var c = b.prevPage;
            "viewer-page" === c.attr("id") && c.jqmData("infoOpen", !!c.find("#info-panel.ui-panel-open").length)
        }), $("#info-panel").on("panelopen", function() {
            var a = JSV.focusNode;
            JSV.resizeViewer(), a && (d3.select("#n-" + a.id).classed("focus", !0), JSV.setPermalink(a))
        }), $("#info-panel").on("panelclose", function() {
            var a = JSV.focusNode;
            JSV.resizeViewer(), a && (d3.select("#n-" + a.id).classed("focus", !1), $("#permalink").html("Select a Node..."), $("#sharelink").val(""))
        }), $("#info-panel").on("tabsactivate", function(a, b) {
        ...
        }), $(".load-example").each(function(a, b) {
            var c = $(b);
            c.on("click", function(a) { a.preventDefault(), JSV.loadInputExample(b.href, c.data("target")) })
        }), d3.selectAll("#zoom-controls>a").on("click", JSV.zoomClick), d3.select("#tree-controls>a#reset-tree").on("click", JSV.resetViewer), $("#sharelink").on("click", function() { $(this).select() }), JSV.viewerInit = !0
    },
    contentHeight: function() {
        var a = $.mobile.getScreenHeight(),
            ...
            e = a - b - c - d;
        $("#main-body.ui-content").css("min-height", e + "px")
    },
    resizeBtn: function(a) {
        var b = "number" == typeof a ? a : 800,
            c = $.mobile.pageContainer.pagecontainer("getActivePage");
        $(".md-navbar", c).width() <= b ? $(".md-navbar .md-flex-btn.ui-btn-icon-left").toggleClass("ui-btn-icon-notext ui-btn-icon-left") : $(".md-navbar .md-flex-btn.ui-btn-icon-notext").toggleClass("ui-btn-icon-left ui-btn-icon-notext")
    },
    setVersion: function(a) { JSV.version = a, $(".schema-version").text(a) },
    showError: function(a) { $("#popup-error .error-message").html(a), $("#popup-error").popup("open") },
        ...
        var a = {
            ...
            on: {
                load: function(a, b) {
                    ...
                    try { $.parseJSON(c), $("#textarea-json").val(c) } catch (d) { JSV.showError("Failed to load " + b.name + ". The file is not valid JSON. <br/>The error: <i>" + d + "</i>") }
                },
                error: function(a, b) {
    ...
    validate: function() {
        ...
        if (a) {
            ...
            if (d) {
                ...
                c = { valid: g, errors: g ? [] : [tv4.error] }
            } else c = tv4.validateMultiple(a, f, !1, e);
            return c
        }
    },
    showValResult: function(a) {
        ...
        c.children().length && c.css("opacity", 0), a.valid ? c.html("<p class=ui-content>JSON is valid!</p>") : (b = c.html("<div class=ui-content>JSON is <b>NOT</b> valid!</div>"), $.each(a.errors, function(a, c) {
            ...
            c.subErrors && $.each(c.subErrors, function(a, b) { d.append(JSV.buildValError(b, "SubError " + (a + 1) + ": ")) }), b.children(".ui-content").first().append(d).enhanceWithin()
        })), c.toggleClass("error", !a.valid), $("#validator-page").animate({ scrollTop: $("#validation-results").offset().top + 20 }, 1e3), c.fadeTo(350, 1)
    },
    buildValError: function(a, b) {
    ...
    setInfo: function(a) {
        ...
        if ($.each([b, c, d], function(a, b) { b.height(e) }), $("#info-definition").html(a.description || "No description provided."), $("#info-type").html(a.displayType.toString()), a.enum) {
            var f = $("<ul></ul>");
            $.each(a.enum, function(a, b) {
                var c = $("<li>" + b + "</li>");
                f.append(c)
            }), $("#info-enums").html(f)
        } else $("#info-enums").html("No enum available.");
        ...
        if (g)
            if (g !== JSV.example) $.getJSON(a.schema.match(/^(.*?)(?=[^\/]*\.json)/g) + g, function(b) {
                var c = g.split("#")[1];
                c && (b = jsonpointer.get(b, c)), JSV.createPre(d, b, !1, a.plainName), JSV.example = g
            }).fail(function() { d.html("<h3>No example found.</h3>"), JSV.example = !1 });
            else {
                var h, i = d.find("pre");
        ...
        else d.html("<h3>No example available.</h3>"), JSV.example = !1
    },
    createPre: function(a, b, c, d) {
    ...
    compilePath: function(a, b) {
        var c;
        return a.parent ? (c = b ? a.name + " > " + b : a.name, JSV.compilePath(a.parent, c)) : c = b ? a.name + " > " + b : a.name
    },
    loadInputExample: function(a, b) { $.getJSON(a).done(function(a) { $("#" + b).val(JSON.stringify(a, null, "  ")) }).fail(function(a, b, c) { JSV.showError("Failed to load example: " + c) }) },
    setPermalink: function(a) {
        var b = new URI,
            c = JSV.getNodePath(a).join("-");
        b.hash($.mobile.activePage.attr("id") + "?v=" + c), $("#permalink").html(JSV.compilePath(a)), $("#sharelink").val(b.toString())
    },
    ...
    expandNodePath: function(a) {
        var b, c = JSV.treeData;
        for (b = 0; b < a.length; b++) c._children && JSV.expand(c), c = c.children[a[b]];
        return JSV.update(JSV.treeData), JSV.centerNode(c), c
    },
    buildSearchList: function(a, b) {
        var c = $("ul#search-result");
        $.each(a, function(a, b) {
            var d = b.split("|"),
                e = $("<li/>").attr("data-icon", "false").appendTo(c);
            $("<a/>").attr("data-path", d[1]).text(d[0]).appendTo(e)
        }), b && c.filterable(), c.filterable("refresh"), c.on("click", function(a) {
            var b = $(a.target).attr("data-path"),
                c = JSV.expandNodePath(b.split("-"));
            JSV.flashNode(c)
        })
    },
    flashNode: function(a, b) {
        for (var c = b || 4, d = $("#n-" + a.id + " text"); c--;) d.fadeTo(350, 0).fadeTo(350, 1)
    },
    ...
    compileData: function(aa, b, c, d, e) {
        if (e = e || 0, !(e > this.maxDepth)) {
            var a, h, w, flag = 0;
            if (aa.$ref && ((aa.$ref.split("/")).pop(-1) == "ResourceList" || (aa.$ref.split("/")).pop(-1) == "Element" || (aa.$ref.split("/")).pop(-1) == "Extension" || (aa.$ref.split("/")).pop(-1) == "BackboneElement" || (aa.$ref.split("/")).pop(-1) == "ElementDefinition")){}

            else{
                if (aa.allOf && Object.getOwnPropertyNames((aa.allOf)[0]) == "$ref") { a = (aa.allOf)[1];
                    flag = ((aa.allOf)[0]["$ref"].split("/")).pop(-1) } else { a = aa }
                var f, g, hh = a.$ref ? tv4.getSchema(a.$ref) : a;
                if (hh.allOf && Object.getOwnPropertyNames((hh.allOf)[0]) == "$ref") { h = (hh.allOf)[1];
                    flag = ((hh.allOf)[0]["$ref"].split("/")).pop(-1) }
                else if(hh.allOf && hh.allOf.length == 1) {h = (hh.allOf)[0]}
                else { h = hh }
                ...
                h.allOf && (l.allOf = h.allOf), h.oneOf && (l.oneOf = h.oneOf), h.anyOf && (l.anyOf = h.anyOf),
                    g = {
                        ...
                        plainName: c,
                        type: flag || h.type,
                        displayType:  flag || w ||h.type || (h["enum"] ? "enum: " + h["enum"].join(", ") : h.items ? "array" : h.properties ? "object" : "ambiguous"),
                        enum: a.enum || h.enum,
                    ...
                    }, g.require = b && b.required ? b.required.indexOf(g.name) > -1 : !1, b ? "item" === g.name ? (g.parent = b, g.type && (g.name = g.type, b.children.push(g))) : "item" === b.name ? b.parent.children.push(g) : b.children.push(g) : JSV.treeData = g, "array" === g.type && (g.name += "[" + (" ") + "]", g.minItems = h.minItems), "object" === g.type && "item" !== g.name && (g.name += "{ }"), (i || j || l) && (g.children = []);

                    if(w && w.split("_")[0] == (JSV.schema.split("/").pop(-1)).split(".")[0]) {g.displayType = "BackboneElement"}
                    else if (g.opacity == 1 && w && i) {g.displayType = w};
                    if (w && g.opacity ==.5 ) {g.name = w};
                    if (g.opacity == .5) {g.level = 1}
                    else if (g.opacity == 1 && w && w.split("_")[0] == (JSV.schema.split("/").pop(-1)).split(".")[0]) {g.level = 2}
                    else if (g.opacity == 1 && w && w == "Reference") {g.level = 3}
                    else if (g.opacity == 1 && w && w != "Reference" ) {g.level = 4}
                    else {g.level = 5};

                for (f in i) k.call(i, f) && JSV.compileData(i[f], g, f, !0, e + 1);
                for (f in l)
                    if (k.call(l, f) && l[f]) {
                        var n = { name: f, children: [], opacity: .5, parentSchema: b, schema: a.$ref || m(b) };
                        "item" === g.name ? g.parent.children.push(n) : g.children.push(n);
                        for (var o = 0; o < l[f].length; o++) JSV.compileData(l[f][o], n, h.title || f, !1, e + 1)
                    }
                    "[object Object]" === Object.prototype.toString.call(j) ? JSV.compileData(j, g, "item", !1, e + 1) : "[object Array]" === Object.prototype.toString.call(j) && j.forEach(function(a, b, c) { JSV.compileData(a, g, b.toString(), !1, e + 1) })
            }
        }
    },
    resizeViewer: function() { JSV.viewerWidth = $("#main-body").width(), JSV.viewerHeight = $("#main-body").height(), JSV.focusNode && JSV.centerNode(JSV.focusNode) },
    resetTree: function(a, b) {
        JSV.visit(a, function(a) { a.children && a.children.length > 0 && a.depth > b && !JSV.labels[a.name] ? JSV.collapse(a) : JSV.labels[a.name] && JSV.expand(a) }, function(a) {
            return a.children && a.children.length > 0 ? a.children : a._children && a._children.length > 0 ? a._children : null
        })
    },
    resetViewer: function() {
        ...
        a.css("display", "block");
        var b = JSV.treeData;
        b.x0 = JSV.viewerHeight / 2;
        b.y0 = 0;
        JSV.tree.nodes(b), JSV.resetTree(b, 1), JSV.update(b), a.css("display", ""), JSV.centerNode(b, 4)
    },
    centerNode: function(a, b) {
        var c = b ? b : 2,
            d = JSV.zoomListener,
            e = d.scale(),
            f = -a.y0 * e + JSV.viewerWidth / c,
            g = -a.x0 * e + JSV.viewerHeight / 2;
        d3.select("g#node-group").transition().duration(JSV.duration).attr("transform", "translate(" + f + "," + g + ")scale(" + e + ")"), d.scale(e), d.translate([f, g])
    },
    collapse: function(a) { a.children && (a._children = a.children, a.children = null) },
    expand: function(a) {
        if (a._children && (a.children = a._children, a._children = null), a.children) {
            var b, c = a.children.length;
            for (b = 0; c > b; b++) JSV.labels[a.children[b].name] && JSV.expand(a.children[b])
        }
    },
    toggleChildren: function(a) {
        return a.children ? JSV.collapse(a) : a._children && JSV.expand(a), a
    },
    click: function(a) {
        if (!JSV.labels[a.name]) {
            if (d3.event && d3.event.defaultPrevented) return;
            a = JSV.toggleChildren(a), JSV.update(a), JSV.centerNode(a)
        }
    },
    clickTitle: function(a) {
        if (!JSV.labels[a.name]) {
            if (d3.event && d3.event.defaultPrevented) return;
            var b = $("#info-panel");
            JSV.focusNode && d3.select("#n-" + JSV.focusNode.id).classed("focus", !1), JSV.focusNode = a, JSV.centerNode(a), d3.select("#n-" + a.id).classed("focus", !0), JSV.plain || (JSV.setPermalink(a), $("#info-title").text("Info: " + a.name).toggleClass("deprecated", !!a.deprecated), JSV.setInfo(a), b.panel("open"))
        }
    },
    zoom: function() { JSV.svgGroup.attr("transform", "translate(" + JSV.zoomListener.translate() + ")scale(" + JSV.zoomListener.scale() + ")") },
    interpolateZoom: function(a, b) {
        return d3.transition().duration(350).tween("zoom", function() {
            var c = d3.interpolate(JSV.zoomListener.translate(), a),
                d = d3.interpolate(JSV.zoomListener.scale(), b);
            return function(a) { JSV.zoomListener.scale(d(a)).translate(c(a)), JSV.zoom() }
        })
    },
    zoomClick: function() {
        ...
        return d3.event.preventDefault(), a = "zoom_in" === this.id ? 1 : -1, c = e.scale() * (1 + b * a), c < f[0] || c > f[1] ? !1 : (h = [(d[0] - j.x) / j.k, (d[1] - j.y) / j.k], j.k = c, i = [h[0] * j.k + j.x, h[1] * j.k + j.y], j.x += d[0] - i[0], j.y += d[1] - i[1], void JSV.interpolateZoom([j.x, j.y], j.k))
    },
    zoomListener: null,
    sortTree: function(a) {
        a.sort(function(a, b) {
    ...
    diagonal1: function(a) {
        var b, c = a.source,
            ...
            e = 0;
        return d && (e = d.getBBox().width), b = "M" + (c.y + e) + "," + c.x + "H" + (a.target.y - 30) + "V" + a.target.x + "h30"
    },
    update: function(a) {
        var b = JSV.duration,
            c = JSV.treeData,
        ...
        e(0, c);
        var f = 50 * d3.max(d); //the height
        JSV.tree.size([f, JSV.viewerWidth]);
        var g = JSV.tree.nodes(c).reverse(),
            h = JSV.tree.links(g);
        g.forEach(function(a) { a.y = a.depth * (10 * JSV.maxLabelLength) }); // the width
        var i = JSV.svgGroup.selectAll("g.node").data(g, function(a) {
            ...
            j = i.enter().append("g").attr("class", function(a) {
                return JSV.labels[a.name] ? "node label" : "node"
            }).attr("id", function(a, b) {
                return "n-" + a.id
            }).attr("transform", function(b) {
                return "translate(" + a.y0 + "," + a.x0 + ")"
            });
        j.append("image").attr("xlink:href",function(ee){return icon[ee.level-1]}).on("click", JSV.click).attr("transform","translate(0,-8)"),

        j.append("text").attr("x", function(a) {return 20}).attr("dy", ".35em").attr("class", function(a) {
            return a.children || a._children ? "node-text node-branch" : "node-text"
        }).attr("text-anchor", function(a) {
            return "start"
        }).text(function(a) {
            return a.name + (a.require ? "*" : "")
        }).style("fill-opacity", 0).on("click", JSV.clickTitle).on("dblclick", function(a) { JSV.click(a), JSV.clickTitle(a), d3.event.stopPropagation() });
        ...
        m.enter().insert("path", "g").attr("class", "link").attr("d", function(b) {
            var c = { x: a.x0, y: a.y0 };
            return JSV.diagonal1({ source: c, target: c })
        }), m.transition().duration(b).attr("d", JSV.diagonal1), m.exit().transition().duration(b).attr("d", function(b) {
            var c = { x: a.x, y: a.y };
            return JSV.diagonal1({ source: c, target: c })
        }).remove(), g.forEach(function(a) { a.x0 = a.x, a.y0 = a.y })
    },
    createDiagram: function(a) {
        tv4.asyncLoad([JSV.schema], function() {
            var schema = (JSV.schema.split("/").pop(-1)).split(".")[0];
            JSV.compileData(tv4.getSchema(JSV.schema), !1, schema);
            var b = 0,
                c = JSV.viewerWidth,
                d = JSV.viewerHeight;
            JSV.zoomListener = d3.behavior.zoom().scaleExtent([.1, 3]).on("zoom", JSV.zoom), JSV.baseSvg = d3.select("#main-body").append("svg").attr("id", "jsv-tree").attr("class", "overlay").attr("width", c).attr("height", d).call(JSV.zoomListener), JSV.tree = d3.layout.tree().size([d, c]), JSV.visit(JSV.treeData, function(a) { b++, JSV.maxLabelLength = Math.max(a.name.length, JSV.maxLabelLength) }, function(a) {
                return a.children && a.children.length > 0 ? a.children : null
            }), JSV.svgGroup = JSV.baseSvg.append("g").attr("id", "node-group"), JSV.resetViewer(), JSV.centerNode(JSV.treeData, 4);

            var e = [{ text: ["Base element"], y: 20}, { text: "Inside element", y: 60}, { text: "Reference element" , y: 100}, { text: "Collapsed elements" , y: 140}, { text: " Single value element", y: 180 }],


                f = d3.select("#legend-items").append("svg").attr("width", 170).attr("height", 200),
            ...
            g.append("image").attr("xlink:href", function(a){ var v = e.indexOf(a); return icon[v]}).attr("transform", function(a){return "translate(-5, -7)"}),
            t = g.append("text").attr("x", 15).attr("dy", ".35em").attr("class", "item-text").attr("text-anchor", "start").style("fill-opacity", function(a) {
                return a.opacity || 1
            ...
            //                 tspan.text(line.join(" "));
            //                 line = [word];
            //                 tspan = t.append("tspan").attr("x",0).attr("y",y).attr("dy", (dy+ 1.1*number)+"em").text(word);
            //             }
            //         }
            // }),
            "function" == typeof a && a()
...
! function(a) {
    a("body").one("pagecontainershow", function(b, c) {
        var d = window.location,
            e = JSV.schema ? JSV.schema : d.origin + d.pathname.substring(0, d.pathname.lastIndexOf("/") + 1) + "schemas/json-schema/Account.schema.json";
