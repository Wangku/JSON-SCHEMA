if (function(a, b) { "use strict"; "object" == typeof exports ? module.exports = b(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" == typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], b) : a.URI = b(a.punycode, a.IPv6, a.SecondLevelDomains, a) }(this, function(a, b, c, d) {
    ...
    compileData: function(aa, b, c, d, e) {
        if (e = e || 0, !(e > this.maxDepth)) {
            ...
            if (hh.allOf && Object.getOwnPropertyNames((hh.allOf)[0]) == "$ref") { h = (hh.allOf)[1];
                flag = ((hh.allOf)[0]["$ref"].split("/")).pop(-1) } else { h = hh }
            ...
            h.allOf && (l.allOf = h.allOf), h.oneOf && (l.oneOf = h.oneOf), h.anyOf && (l.anyOf = h.anyOf),
                g = {
                    ...
                    parentSchema: b,
                    deprecated: a.deprecated || h.deprecated
                }, g.require = b && b.required ? b.required.indexOf(g.name) > -1 : !1, b ? "item" === g.name ? (g.parent = b, g.type && (g.name = g.type, b.children.push(g))) : "item" === b.name ? b.parent.children.push(g) : b.children.push(g) : JSV.treeData = g, "array" === g.type && (g.name += "[" + (h.minItems || " ") + "]", g.minItems = h.minItems), "object" === g.type && "item" !== g.name && (g.name += "{ }"), (i || j || l) && (g.children = []);
    ...
    update: function(a) {
        ...
        e(0, c);
        var f = 35 * d3.max(d); //the height
        JSV.tree.size([f, JSV.viewerWidth]);
        var g = JSV.tree.nodes(c).reverse(),
            h = JSV.tree.links(g);
        g.forEach(function(a) { a.y = a.depth * (15 * JSV.maxLabelLength) }); // the width
        ...
        }).on("click", JSV.click), j.append("text").attr("x", function(a) {
            return 10
        }).attr("dy", ".35em").attr("class", function(a) {
            return a.children || a._children ? "node-text node-branch" : "node-text"
        }).classed("abstract", function(a) {
            return a.opacity < 1
        }).attr("text-anchor", function(a) {
            return "start"
        }).text(function(a) {
            return a.name + (a.require ? "*" : "")
        }).style("fill-opacity", 0).on("click", JSV.clickTitle).on("dblclick", function(a) { JSV.click(a), JSV.clickTitle(a), d3.event.stopPropagation() }), i.select(".node circle").attr("r", 6.5).classed("collapsed", function(a) {
            return a._children ? !0 : !1
        });
    ...
    createDiagram: function(a) {
        tv4.asyncLoad([JSV.schema], function() {
            ...
            g.append("circle").attr("r", 6.5).attr("class", function(a) {
                return a.iconCls
            }), g.append("text").attr("x", 15).attr("dy", ".35em").attr("class", "item-text").attr("text-anchor", "start").style("fill-opacity", function(a) {
                return a.opacity || 1
            }).text(function(a) {
                return a.text
            }), "function" == typeof a && a()
...
! function(a) {
    a("body").one("pagecontainershow", function(b, c) {
        ...
        // JSV.schema = "./schemas/json-schema/fhir.schema.json"
