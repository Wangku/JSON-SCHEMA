 ...
 if (function(a, b) { "use strict"; "object" == typeof exports ? module.exports = b(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" == typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], b) : a.URI = b(a.punycode, a.IPv6, a.SecondLevelDomains, a) }(this, function(a, b, c, d) {
    ...
    createDiagram: function(a) {
        tv4.asyncLoad([JSV.schema], function() {
            ...
            var e = [{ text: "Base element", y: 20}, { text: "Inside element", y: 40}, { text: "Reference element" , y: 60}, { text: "Collapsed elements" , y: 80}, { text: " Single value element", y: 100 }],


                f = d3.select("#legend-items").append("svg").attr("width", 170).attr("height", 120),
            ...
            g.append("image").attr("xlink:href", function(a){ var v = e.indexOf(a); return icon[v]}).attr("transform", function(a){return "translate(-5, -7)"}), g.append("text").attr("x", 15).attr("dy", ".35em").attr("class", "item-text").attr("text-anchor", "start").style("fill-opacity", function(a) {
                return a.opacity || 1
            }).text(function(a) {
                return a.text
            }), "function" == typeof a && a()
